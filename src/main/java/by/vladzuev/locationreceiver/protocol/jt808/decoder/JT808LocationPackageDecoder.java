...
import static by.vladzuev.locationreceiver.protocol.jt808.util.JT808Util.*;
import static java.util.stream.Collectors.collectingAndThen;
import static java.util.stream.Collectors.toList;
import static java.util.stream.IntStream.range;

public abstract class JT808LocationPackageDecoder extends JT808PackageDecoder {
    private static final int EXTRA_LOCATION_DATA_BYTE_COUNT = 38;
    ...
    private void skipLocationExtraData(final ByteBuf buffer) {
        buffer.skipBytes(EXTRA_LOCATION_DATA_BYTE_COUNT);
    }
}
