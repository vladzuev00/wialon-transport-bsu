...
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_TRACKER_IMEI),
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_DATE_TIME_NAME),
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_LATITUDE_NAME),
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_LONGITUDE_NAME),
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_CITY_NAME),
//                PDFCellFactoryUtil.createTextCell(TABLE_HEADER_COLUMN_OF_COUNTRY_NAME)
//        };
//    }
//
...
//                .add(PDFCellFactoryUtil.createTextCell(cityName))
//                .add(PDFCellFactoryUtil.createTextCell(countryName))
//                .build();
//    }
//
