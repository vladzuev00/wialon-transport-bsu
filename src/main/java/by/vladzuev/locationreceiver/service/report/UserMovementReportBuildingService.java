package by.vladzuev.locationreceiver.service.report;

import by.vladzuev.locationreceiver.crud.dto.User;
import by.vladzuev.locationreceiver.model.DateInterval;
import by.vladzuev.locationreceiver.service.report.exception.UserMovementReportBuildingException;
import by.vladzuev.locationreceiver.service.report.factory.UserMovementReportBuildingContextFactory;
import by.vladzuev.locationreceiver.service.report.model.UserMovementReportBuildingContext;
import by.vladzuev.locationreceiver.service.report.tableappender.AbstractUserMovementReportTableAppender;
import by.vladzuev.locationreceiver.util.PDFUtil;
...
public final class UserMovementReportBuildingService {
    ...
    private static void addIntroduction(final UserMovementReportBuildingContext context)
        ...
        final PDPage page = PDFUtil.addPage(document);
