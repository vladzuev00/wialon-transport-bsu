...
public final class UserTrackersReportTableAppender extends AbstractUserMovementReportTableAppender {
    ...
    protected AbstractCell[] createHeaderRowCells() {
        return new AbstractCell[]{
                PDFCellFactoryUtil.createTextCell(HEADER_ROW_COLUMN_OF_IMEI_NAME),
                PDFCellFactoryUtil.createTextCell(HEADER_ROW_COLUMN_OF_PHONE_NUMBER_NAME),
                PDFCellFactoryUtil.createTextCell(HEADER_ROW_COLUMN_OF_COUNT_OF_POINTS_NAME)
        };
    }
    ...
    private static Row createContentRow(final TrackerMovement movement) {
        ...
        return Row.builder()
                ...
                .add(PDFCellFactoryUtil.createTextCell(trackerPhoneNumber))
                .add(PDFCellFactoryUtil.createTextCell(countOfPoints))
                .build();
    }
