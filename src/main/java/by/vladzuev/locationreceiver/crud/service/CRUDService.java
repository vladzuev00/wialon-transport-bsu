...
public abstract class CRUDService<
    ...
    public List<DTO> findByIds(final Iterable<ID> ids) {
        return CollectionUtil.mapToList(repository.findAllById(ids), mapper::mapToDto);
    }
    ...
    public List<DTO> saveAll(final Collection<DTO> dtos) {
        ...
        return CollectionUtil.mapToList(savedEntities, mapper::mapToDto);
    }
    ...
    private List<ENTITY> mapToConfiguredEntities(final Collection<DTO> dtos) {
        return CollectionUtil.mapToList(dtos, this::mapToConfiguredEntity);
    }
}