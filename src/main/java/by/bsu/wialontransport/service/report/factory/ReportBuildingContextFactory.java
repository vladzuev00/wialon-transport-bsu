...
public final class ReportBuildingContextFactory {
    ...
    public ReportBuildingContext create(final User user, final DateInterval dateInterval) {
        ...
        try {
            ...
            return ReportBuildingContext.builder()
                    .user(user)
