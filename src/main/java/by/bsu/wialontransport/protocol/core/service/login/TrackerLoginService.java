...
public abstract class TrackerLoginService<PACKAGE extends LoginPackage> {
    ...
    private void sendNoSuchImeiResponse(final ChannelHandlerContext context) {
        sendResponse(context, this::createNoSuchImeiResponse);
    }

    private void sendSuccessResponse(final ChannelHandlerContext context) {
        sendResponse(context, this::createSuccessResponse);
    }

    private static void sendResponse(final ChannelHandlerContext context, final Supplier<Package> responseSupplier) {
