...
public final class WialonEncoder extends MessageToByteEncoder<Package> {
    ...
    @Override
    protected void encode(final ChannelHandlerContext channelHandlerContext, final Package responsePackage,
