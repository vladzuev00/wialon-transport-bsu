...
VALUES(255, ST_GeomFromText('POLYGON((1 1, 1 2, 2 2, 2 1, 1 1))', 4326), ST_SetSRID(ST_POINT(1.5, 1.5), 4326), 'first-city', 'first-country', ST_GeomFromText('POLYGON((1 1, 1 2, 2 2, 2 1, 1 1))', 4326)),
      (257, ST_GeomFromText('POLYGON((3 3, 3 4, 4 4, 4 3, 3 3))', 4326), ST_SetSRID(ST_POINT(1.5, 1.5), 4326), 'first-city', 'first-country', ST_GeomFromText('POLYGON((3 3, 4 3, 4 4, 3 3))', 4326)),
      (259, ST_GeomFromText('POLYGON((3 1, 4 1, 4 2, 3 2, 3 1))', 4326), ST_SetSRID(ST_POINT(1.5, 1.5), 4326), 'first-city', 'first-country', ST_GeomFromText('POLYGON((3 1, 4 1, 4 2, 3 2, 3 1))', 4326));
