package by.vladzuev.locationreceiver.kafka.consumer.deserializer;
...
public final class AvroGenericRecordDeserializerTest {
    ...
    private static GenericDatumReader<GenericRecord> findDatumReader(final AvroGenericRecordDeserializer deserializer) {
        return (GenericDatumReader<GenericRecord>) ReflectionUtil.getProperty(deserializer, FIELD_NAME_DATUM_READER, DatumReader.class);
    }
