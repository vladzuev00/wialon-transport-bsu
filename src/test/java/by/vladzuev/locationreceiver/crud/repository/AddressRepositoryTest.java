...
import static by.vladzuev.locationreceiver.util.entity.EntityUtil.mapToIdsSet;
...
public final class AddressRepositoryTest extends AbstractSpringBootTest {
    ...
    public void addressShouldBeFoundById() {
        ...
        final AddressEntity expected = AddressEntity.builder()
                .id(givenId)
                .boundingBox(GeometryTestUtil.createPolygon(geometryFactory, 1, 1, 1, 2, 2, 2, 2, 1))
                .center(GeometryTestUtil.createPoint(geometryFactory, 1.5, 1.5))
                .cityName("first-city")
                .countryName("first-country")
                .geometry(GeometryTestUtil.createPolygon(geometryFactory, 1, 1, 1, 2, 2, 2, 2, 1))
                .build();
    ...
    public void addressShouldBeSaved() {
        final AddressEntity givenAddress = AddressEntity.builder()
                ...
                .center(GeometryTestUtil.createPoint(geometryFactory, 53.050287, 24.873636))
                .cityName("city")
                .countryName("country")
