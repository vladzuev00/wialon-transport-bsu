...
public final class NewWingLocationPackageHandlerTest {
    ...
    public void locationSourcesShouldBeStreamed() {
        ...
        final Stream<NewWingLocation> actual = handler.streamLocationSources(givenRequest);
        final List<NewWingLocation> actualAsList = actual.toList();
        Assertions.assertEquals(givenLocations, actualAsList);
    }
    ...
    @Test
    public void parametersShouldBeStream() {
        final NewWingLocation givenLocation = NewWingLocation.builder().build();
