package by.vladzuev.locationreceiver.protocol.it.newwing;

import by.vladzuev.locationreceiver.config.property.protocolserver.NewWingProtocolServerConfig;
...
import by.vladzuev.locationreceiver.protocol.it.core.ProtocolIT;
import by.vladzuev.locationreceiver.util.entity.DataEntityUtil;
...
public final class NewWingProtocolIT extends ProtocolIT {
    ...
    public void dataPackageShouldBeHandledInCaseNotExistingPreviousDataAndAddressShouldBeReceivedFromDatabase()
        ...
        final DataEntity expectedData = DataEntity.builder()
                ...
                .coordinate(new DataEntity.Coordinate(53.9163017272949, 27.5623168945312))
                .speed(0.1)
                .course(182)
                .altitude(0)
