...
public final class ApelRequestExtendedLoginPackageDecoderTest {
    ...
    public void packageShouldBeDecodedStartingFromBody() {
        ...
        final ApelRequestExtendedLoginPackage actual = decoder.decodeStartingFromBody(givenBuffer);
        final ApelRequestExtendedLoginPackage expected = new ApelRequestExtendedLoginPackage("356895036279811", " ");
