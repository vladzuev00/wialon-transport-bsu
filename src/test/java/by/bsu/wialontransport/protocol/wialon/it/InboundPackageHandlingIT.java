...
//
//        verify(this.mockedRestTemplate, times(0)).exchange(
//                anyString(), same(GET), same(EMPTY), any(ParameterizedTypeReference.class)
//        );
//
...
////        ).thenReturn(
////                ok(
////                        createNominatimReverseResponse(
////                                57.406944,
////                                37.54833,
////                                "city",
////                                "country",
////                                new double[]{55.506944, 59.506944, 37.54833, 41.54833},
////                                createPolygon(this.geometryFactory, )
////                        )
////                )
////        );
////
...
//    }
//
//    private NominatimReverseResponse createNominatimReverseResponse(final double centerLatitude,
...
//                centerLatitude,
//                centerLongitude,
//                new NominatimReverseResponse.Address(cityName, countryName),
//                boundingBoxCoordinates,
//                this.geoJSONWriter.write(geometry),
//                new NominatimReverseResponse.ExtraTags(place, capital)
//        );
//    }
//
