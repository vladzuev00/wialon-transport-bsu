...
public final class DataFixerTest {
    ...
    public void dataShouldBeFixed() {
        final DataFixer givenFixer = createFixer(true);
        ...
        final Data actual = givenFixer.fix(givenFixed, givenPrevious);
    ...
    @Test
    public void dataShouldNotBeFixedBecauseOfFixingIsNotEnabled() {
        final DataFixer givenFixer = createFixer(false);
        ...
        final Data actual = givenFixer.fix(givenFixed, givenPrevious);
        assertSame(givenFixed, actual);
    }

    private static DataFixer createFixer(final boolean fixingEnable) {
        return new DataFixer(fixingEnable);
    }
