...
//        verify(this.mockedContextAttributeManager, times(1))
//                .putLastChannelData(this.contextArgumentCaptor.capture(), this.dataArgumentCaptor.capture());
//
//        assertEquals(
...
//                .putLastChannelData(any(ChannelHandlerContext.class), any(Data.class));
//
