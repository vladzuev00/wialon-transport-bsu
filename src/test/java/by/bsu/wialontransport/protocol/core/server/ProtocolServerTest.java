...
public final class ProtocolServerTest {
    ...
    private static final String FIELD_NAME_CONNECTION_LIFE_TIMEOUT_SECONDS = "connectionLifeTimeoutSeconds";
    ...
    public void serverShouldBeCreated() {
        ...
        final ContextAttributeManager actualContextAttributeManager = actualRunningContext.getContextAttributeManager();
